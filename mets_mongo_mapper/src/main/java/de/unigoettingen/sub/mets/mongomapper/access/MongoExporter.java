package de.unigoettingen.sub.mets.mongomapper.access;
...
import de.unigoettingen.sub.mets.mongomapper.helper.DocInfo;
import de.unigoettingen.sub.mets.mongomapper.helper.IdHelper;
...
public class MongoExporter {
     ...
     */
    public MongoExporter(String db_name, String coll_name) {

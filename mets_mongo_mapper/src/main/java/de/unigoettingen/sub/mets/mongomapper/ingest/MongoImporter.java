package de.unigoettingen.sub.mets.mongomapper.ingest;
...
import de.unigoettingen.sub.mets.mongomapper.helper.*;
...
public class MongoImporter {
     ...
     */
    public MongoImporter(String db_name, String coll_name) {
    ...
    public void processTeiAndStore(MultipartFile teiFile, String docid, String type, String teiType, String appUrlString) {
        ...
        this.writeToMongo(prepareForStorage(), teiFile);

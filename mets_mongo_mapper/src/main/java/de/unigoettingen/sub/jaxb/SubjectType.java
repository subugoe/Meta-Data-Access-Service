...
public class SubjectType {
    ...
    protected List<JAXBElement<?>> topicsAndGeographicsAndTemporals;
     ...
     * 
     */
    public List<JAXBElement<?>> getTopicsAndGeographicsAndTemporals() {
        if (topicsAndGeographicsAndTemporals == null) {
            topicsAndGeographicsAndTemporals = new ArrayList<JAXBElement<?>>();
        }

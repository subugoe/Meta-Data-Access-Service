...
public class OriginInfoType {
    ...
    protected List<JAXBElement<?>> placesAndPublishersAndDateIssueds;
     ...
     * 
     */
    public List<JAXBElement<?>> getPlacesAndPublishersAndDateIssueds() {
        if (placesAndPublishersAndDateIssueds == null) {
            placesAndPublishersAndDateIssueds = new ArrayList<JAXBElement<?>>();
        }

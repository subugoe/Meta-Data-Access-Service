...
public class DetailType {
    ...
    protected List<JAXBElement<String>> numbersAndCaptionsAndTitles;
     ...
     * 
     */
    public List<JAXBElement<String>> getNumbersAndCaptionsAndTitles() {
        if (numbersAndCaptionsAndTitles == null) {
            numbersAndCaptionsAndTitles = new ArrayList<JAXBElement<String>>();
        }

 ...
 *       &lt;attribute name="STRUCTID" use="required" type="{http://www.w3.org/2001/XMLSchema}IDREFS" />
...
@XmlType(name = "behaviorType", namespace = "http://www.loc.gov/METS/", propOrder = {
    "interfaceDef",
    "mechanism"
})
public class BehaviorType {
    ...
    protected String id;
    @XmlAttribute(name = "STRUCTID", required = true)
    @XmlIDREF

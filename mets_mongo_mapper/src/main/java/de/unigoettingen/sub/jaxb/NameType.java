...
public class NameType {
    ...
    protected List<JAXBElement<?>> namePartsAndDisplayFormsAndAffiliations;
     ...
     * 
     */
    public List<JAXBElement<?>> getNamePartsAndDisplayFormsAndAffiliations() {
        if (namePartsAndDisplayFormsAndAffiliations == null) {
            namePartsAndDisplayFormsAndAffiliations = new ArrayList<JAXBElement<?>>();
        }
